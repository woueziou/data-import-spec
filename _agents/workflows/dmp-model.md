...
4. Keep the response structured, handoff-ready, and non-executable. End by handing off to `/dmp-consult` when the modeling artifacts are complete enough for user review.
